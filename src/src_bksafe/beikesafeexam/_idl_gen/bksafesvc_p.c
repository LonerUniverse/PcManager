...
const CInterfaceProxyVtbl * const _bksafesvc_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IbkcommProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _bksafesvc_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IbkcommStubVtbl,
    0
};
...
const IID *  const _bksafesvc_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
